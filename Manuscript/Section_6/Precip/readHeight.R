...
getHeight <- function(loc) {
    ...
    ex <- file.exists("Precip/data/c10g")
    if (!ex) {
        download.file("https://www.dropbox.com/scl/fi/z1kk4jt0pkyozushy9hwh/c10g?rlkey=dniw6qapd3f1hvgswjc0fyafu&e=1&dl=0", "data/c10g")
    }

    # Read file
    inFile <- file("Precip/data/c10g", "rb")
